              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition ${
                    active ? "bg-[#FFD200] text-[#111827] shadow-sm" : "text-[#4B5563] hover:bg-[#FFF7D1]"
                  }`}
                >
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="border-b border-black/5 bg-white">
            <div className="flex flex-col gap-4 px-5 py-4 lg:flex-row lg:items-center lg:justify-between lg:px-8">
              <div>
                <p className="text-xs font-semibold uppercase text-[#A87900]">Debtor Portal</p>
              ...
              <form action={logout}>
                ...
                >
                  <span className="max-w-40 truncate">{profile.full_name}</span>
